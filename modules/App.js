...
export default React.createClass({
  render() {
    return <div>
      ...
      <p>This is an example of how to use the <a href="https://developers.arcgis.com/javascript/" target="_blank">ArcGIS API for JavaScript</a> in a <a href="https://github.com/reactjs/react-router-tutorial">react-router</a> application.</p>
